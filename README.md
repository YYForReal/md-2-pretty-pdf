...
1. **输入 Markdown**：在左侧编辑器中输入或粘贴 Markdown 内容
2. **选择主题**：从右侧控制面板选择预设主题
3. **自定义样式**：调整字体、颜色、边距等参数
4. **预览效果**：点击"预览"按钮查看效果
5. **下载 PDF**：满意后点击"下载 PDF"保存文件
